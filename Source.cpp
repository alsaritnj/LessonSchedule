...
//
//	FiveDaySchedule sc;
//	sc.addTeacher(new TeacherName("Êèðèëîâ", "Âàñèëüåâ"));
//	sc.addTeacher(new TeacherName("Âëàäìèðîâà", "Ñîôèÿ"));
//	sc.addSubject(new SimpleSubject("Ðóññêèé", sc.getTeacher(0)));
//	sc.addSubject(new SimpleSubject("Êèðèëèöà", sc.getTeacher(1)));
