...
SimpleLessonInScheduleCreator::SimpleLessonInScheduleCreator(std::vector<Subject*>& subjectList, std::vector<Classroom*>& classroomList) :
	...
	({
		Question("Subject", Question::existing, transformArrayOfPtrToArrayOfPtrOnClassName(subjectList.data(), subjectList.size()), subjectList.size()),
		Question("Classroom", Question::existing, transformArrayOfPtrToArrayOfPtrOnClassName(classroomList.data(), classroomList.size()), classroomList.size()),
